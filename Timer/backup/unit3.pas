...
procedure Formcondition(var X:TForm3);
begin
     if X.Height = 36 then
     begin
...
procedure maka(var X:TForm3); //inserer le temps dans les variables
var
  i, L, prix, j: integer;
begin
     heur:=0;
...
begin
     ...
     begin
          readln(M, i);
          Form3.ComboBox1.Items.Add(IntToStr(i));
     end;

     while not EOF(H) do
     begin
          readln(H, j);
          Form3.ComboBox2.Items.Add(IntToStr(j));
     end;
...
procedure manoratra(var X:TForm3); //changer le label du temps
begin
