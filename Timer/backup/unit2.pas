...
procedure Formcondition(var X:TForm2); //condition des forms
begin
     if X.Height = 36 then
     begin
...
procedure maka(var X:TForm2); //inserer le temps dans les variables
var
  i, L, prix, j: integer;
begin
     heur:=0;
...
begin
     ...
     begin
          readln(H, j);
          Form2.ComboBox2.Items.Add(IntToStr(j));
     end;
...
procedure manoratra(var X:TForm2); //changer le label du temps
begin
