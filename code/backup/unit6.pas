...
procedure Formcondition(var X:TForm6);
begin
     if X.Height = 36 then
     begin
...
procedure maka(var X:TForm6); //inserer le temps dans les variables
var
  i, L, prix, j: integer;
begin
     heur:=0;
...
begin
     ...
     begin
          readln(H, j);
          Form6.ComboBox2.Items.Add(IntToStr(j));
     end;
...
procedure manoratra(var X:TForm6); //changer le label du temps
begin
