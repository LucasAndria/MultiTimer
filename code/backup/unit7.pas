...
procedure Formcondition(var X:TForm7);
begin
     if X.Height = 36 then
     begin
...
procedure maka(var X:TForm7); //inserer le temps dans les variables
var
  i, L, prix, j: integer;
begin
     heur:=0;
...
begin
     ...
     begin
          readln(M, i);
          Form7.ComboBox1.Items.Add(IntToStr(i));
     end;

     while not EOF(H) do
     begin
          readln(H, j);
          Form7.ComboBox2.Items.Add(IntToStr(j));
     end;
...
procedure manoratra(var X:TForm7); //changer le label du temps
begin
