...
procedure Formcondition(var X:TForm9);
begin
     if X.Height = 36 then
     begin
...
procedure maka(var X:TForm9); //inserer le temps dans les variables
var
  i, L, prix, j: integer;
begin
     heur:=0;
...
begin
     ...
     begin
          readln(M, i);
          Form9.ComboBox1.Items.Add(IntToStr(i));
     end;

     while not EOF(H) do
     begin
          readln(H, j);
          Form9.ComboBox2.Items.Add(IntToStr(j));
     end;
...
procedure manoratra(var X:TForm9); //changer le label du temps
begin
...
procedure TForm9.Image1DblClick(Sender: TObject);
begin
